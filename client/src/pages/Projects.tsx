      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <Link key={i} href={`/projects/${i}`}>
            <div className="border border-border bg-card p-6 rounded-lg hover:border-primary transition-colors group animate-in zoom-in-95 duration-500 cursor-pointer" style={{ animationDelay: `${i * 100}ms` }}>
