  ...
  return (
    <div className="min-h-screen bg-background p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {[1, 2, 3, 4].map((i) => (
          <Link key={i} href={`/recipes/${i}`}>
            <div className="bg-card border border-border p-6 rounded-xl flex gap-4 animate-in zoom-in-95 duration-500 hover:bg-accent/5 transition-colors cursor-pointer" style={{ animationDelay: `${i * 100}ms` }}>
